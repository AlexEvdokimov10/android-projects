...
class FileData extends Data
{
    ...
    const STUD_FILE_TEMPLATE = "/^student_\d\d.txt\z/";
    const GROUP_FILE_TEMPLATE = "/^group_\d\d\z/";
    ...
    protected function setStudent(Student $student)
    {
        ...
        $grArr = array($student->getName(), $gender, $student->getDob()->format('d.m.Y'), $privilege,);
        $grStr = implode(';', $grArr);
        fwrite($f, $grStr);
        fclose($f);
    }
    ...
    protected function insStudent(Student $student)
    {
        ...
        $newFileName = 'student_' . $file_index . '.txt';
